...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/kOuD6RBvoz)
...
```sh
npx nx serve jobfinder
```

To create a production bundle:

```sh
npx nx build jobfinder
```

To see all available targets to run for a project, run:

```sh
npx nx show project jobfinder
```
